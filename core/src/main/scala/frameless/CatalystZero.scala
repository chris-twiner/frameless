...
abstract class CatalystZero[A](
    implicit
    ev: NotCatalystNullable[A]) {
  def zero: A
}
...
object CatalystZero {
  ...
  implicit val framelessZeroBigDecimal: CatalystZero[BigDecimal] =
    CatalystZero(zero = BigDecimal(0))

  implicit val framelessZeroDouble: CatalystZero[Double] =
    CatalystZero(zero = 0.0)
  ...
  implicit val framelessZeroBooleanOrdered: CatalystZero[Boolean] =
    CatalystZero(zero = false)
  implicit val framelessZeroByte: CatalystZero[Byte] = CatalystZero(zero = 0)

  implicit val framelessZeroFloat: CatalystZero[Float] =
    CatalystZero(zero = 0.0F)

  implicit val framelessZeroSQLDate: CatalystZero[SQLDate] =
    CatalystZero(zero = SQLDate(0))

  implicit val framelessZeroSQLTimestamp: CatalystZero[SQLTimestamp] =
    CatalystZero(zero = SQLTimestamp(0))

  implicit val framelessZeroString: CatalystZero[String] =
    CatalystZero(zero = "")

  implicit val framelessZeroInstant: CatalystZero[Instant] =
    CatalystZero(zero = Instant.now())

  implicit val framelessZeroDuration: CatalystZero[Duration] =
    CatalystZero(zero = Duration.ZERO)

  implicit val framelessZeroPeriod: CatalystZero[Period] =
    CatalystZero(zero = Period.ZERO)
