...
import org.apache.spark.sql.catalyst.encoders.AgnosticEncoders.{EncoderField, ProductEncoder, RowEncoder}
...
class As[T, U] private (val resultingEncoder: TypedEncoder[U], val originalEncoder: TypedEncoder[T]) {
